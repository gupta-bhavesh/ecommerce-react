      ...
      <div className="filters-field">
        ...
        {products.length === 0 && isLoading ? (
          ...
          >
            ...
            <option value="Tata Soulful">Tata Soulful</option>
            <option value="Nature\'s Soul">Nature's Soul</option>
            <option value="Kaulige Foods">Kaulige Foods</option>
            <option value="Tru Millets">Tru Millets</option>
          </select>
        )}
      </div>
      <div className="filters-field">
