...
const brandOptions = [
  { value: 'Tata Soulful', label: 'Tata Soulful' },
  { value: 'Nature\'s Soul', label: 'Nature\'s Soul' },
  { value: 'Kaulige Foods', label: 'Kaulige Foods' },
  { value: 'Tru Millets', label: 'Tru Millets' }
];
